...
class AnimalForm: FormView, FormDelegate {
    ...
    private func setupForm() {
        ...
        let species = PickerFormField(value: NSLocalizedString("cat", comment: ""), values: [NSLocalizedString("dog", comment: ""), NSLocalizedString("cat", comment: "")], labelText: NSLocalizedString("species", comment: ""))
