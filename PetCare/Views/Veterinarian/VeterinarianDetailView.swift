...
class VeterinarianDetailView: UIView {
    ...
    private let appointmentsTableView: UITableView = {
        ...
        tableView.register(VeterinaryAppointmentTableViewCell.self, forCellReuseIdentifier: VeterinaryAppointmentTableViewCell.reuseIdentifier)
...
extension VeterinarianDetailView: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: VeterinaryAppointmentTableViewCell.reuseIdentifier, for: indexPath) as! VeterinaryAppointmentTableViewCell
